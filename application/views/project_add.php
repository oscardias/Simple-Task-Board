...
<form class="form-horizontal" method="post" action="<?php echo base_url('project/save'); ?>">
    ...
    <fieldset>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="control-group">
                    <label class="control-label" for="github_repo">Github Repo</label>
                    <div class="controls">
                        <input type="text" class="input-xxlarge" name="github_repo" id="github_repo" placeholder="owner/repo" value="<?php echo set_value('github_repo', $github_repo); ?>" />
                    </div>
                </div>
            </div>
        </div>
